...
class UnitTest extends TestCase
{
    ...
    public function testAgainCollectionOfProduct(): void
    {
        self::seed([CategorySeeder::class, ProductSeeder::class, ProductSeederAgain::class]);

        $response = $this->get("/api/products/conditional/category-loaded")
            ->assertStatus(200)
            ->assertHeader('X-Powered-By', 'Arief Karditya Hermawan');
    ...
    public function testResponseMethodCollectionOfProduct(): void
    {
        self::seed([CategorySeeder::class, ProductSeeder::class, ProductSeederAgain::class]);
